    ...
    >
      ...
      >
        <NuxtLink
          ...
          class="absolute z-20 m-5 rounded-full bg-gray-700 p-1.5 hover:bg-gray-800 flex items-center justify-center"
        >
          <Icon name="material-symbols:close" size="27" class="text-white" />
        </NuxtLink>
      ...
      >
        ...
        <div class="px-8 mt-4 text-sm font-bold flex items-center">
          <Icon name="mdi:music" size="17" class="mr-1.5" />
          original sound -
          {{
            $generalStore.allLowerCaseNoCaps(
              $generalStore.selectedPost.user.name
        ...
        <div class="flex items-center px-8 mt-8">
          <div class="pb-4 text-center flex items-center">
            <button
              ...
              class="rounded-full bg-gray-200 p-2 cursor-pointer flex items-center justify-center"
            >
              <Icon
                name="mdi:heart"
                size="25"
                :class="isLiked ? 'text-[#F02C56]' : 'text-gray-800'"
              />
            </button>
