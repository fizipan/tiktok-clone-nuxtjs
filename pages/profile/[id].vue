  ...
  <NuxtLayout>
    ...
    >
      ...
      <div class="w-full flex items-center pt-4 border-b">
        ...
        <div
          class="w-60 text-gray-500 text-center py-2 text-[17px] font-semibold flex justify-center items-center"
        >
          <Icon name="material-symbols:lock-open" class="mr-1.5" /> Liked
        </div>
      </div>
